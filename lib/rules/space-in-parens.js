...
module.exports = {
  ...
  create( context ) {
    ...
    const exceptionsArrayOptions = ( context.options.length === 2 ) ? context.options[ 1 ].exceptions : [];
    const options = {};
    let exceptions;
    ...
    function shouldCloserHaveSpace( left, right ) {
      ...
      const closerException = isCloserException( left );
      return ALWAYS ? !closerException : closerException;
    }
